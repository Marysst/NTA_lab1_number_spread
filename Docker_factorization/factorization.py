import random, math, time, sympy, itertools, sys
import numpy as np
    ...
    def factorize(n):
        ...
        if divisor1 and divisor2:
            if divisor1 == 1 or divisor2 == 1:
                ...
                print("Я міг би змінити значення альфа і розширити факторну базу, але на цьому пристрої з більшою факторною базою я працюватиму занадто довго :( Sorry")
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python factorization.py <number>")
        sys.exit(1)
    ...
    try:
        ...
        print("Error: Введіть коректне ціле число.")