...
for num in numbers:
    ...
    # Поллард Ро
    factor_pollard, time_pollard = measure_time(pollard_rho, num)
    print(f"  Поллард Ро: дільник = {factor_pollard}, час = {time_pollard:.6f} с")
    
    # Брілхарт-Моррісон
    factor_bm, time_bm = measure_time(drillhart_morrison, num)
    print(f"  Брілхарт-Моррісон: дільник = {factor_bm}, час = {time_bm:.6f} с")
    print("-" * 50)